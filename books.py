...
def search_command():
    list1.delete(0,END)
    for row in server.search(title_text.get(),author_text.get(),year_text.get(),price_text.get()):
        list1.insert(END,row)

def insert_command():
    server.insert(title_text.get(),author_text.get(),year_text.get(),price_text.get())
    list1.delete(0,END)
...
def update_command():
    server.update(title_text.get(),author_text.get(),year_text.get(),price_text.get(),selected_tuple[0])
